  ...
  return (
    <div className="">
		<main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 text-white bg-background dark:bg-black sm:items-start">
			...
			<Link href="/dashboard">
				<Button className="border border-primary w-60 hover:bg-primary dark:bg-white dark:text-primary cursor-pointer">
					Go to the Dashboard
					<ArrowRight />
				</Button>
			</Link>
			...
			<Link href="/dashboard/learn/academic/beginner/units/">
				<Button on className="text-white border border-primary w-60 hover:bg-primary cursor-pointer">
					Go to A1 Lessons
					<ArrowRight />
				</Button>
			</Link>
